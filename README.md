...
The School Management System is a web-based application built using the MERN (MySql, Express.js, React.js, Node.js) stack. It aims to streamline school management, class organization, and facilitate communication between students, teachers, and administrators.
...
```sh
git clone https://github.com/Abdul-Muhsin39/-GI-KACE-Final-Project.git
```
